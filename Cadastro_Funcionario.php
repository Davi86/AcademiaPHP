	...
	<div class="section">
			...
			<div class="col s10">
				<div class="card amber" style="padding: 2px;">
					<div class="card-content grey darken-4">
							<span class="card-title center white-text">CADASTRO DOS FUNCIONÁRIOS</span>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="card grey darken-4">
					<div class="card-content">
						<div class="input-field">
							...
							<input type="number" name="idade" id="autocomplete2" class="autocomplete white-text">
				...
				<div class="card grey darken-4">
					<div class="card-content">
						<div class="input-field">
							...
							<input type="text" name="cargo" id="autocomplete4" class="autocomplete white-text" required>
							<label for="autocomplete4" class="white-text">Cargo</label>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card grey darken-4">
					<div class="card-content">
						<div class="input-field">
							...
							<input type="text" name="rua" id="autocomplete8" class="autocomplete rua white-text">
				...
				<div class="card grey darken-4">
					<div class="card-content">
						<div class="input-field">
							...
							<input type="text" name="cidade" class="cidade autocomplete" placeholder="Cidade">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col s10">
				<div class="card grey darken-4">
					<div class="card-content">
						<span class="card-title center white-text">LOGIN NO SITE:</span>
					</div>
				</div>
			</div>
			<div class="col s1"></div>
				...
				<div class="card grey darken-4">
					<div class="card-content">
						<div class="input-field">
							...
							<input type="text" name="usuario" id="autocomplete15" class="autocomplete white-text" required>
							<label for="autocomplete15" class="white-text">Usuário</label>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card grey darken-4">
					<div class="card-content">
						<div class="input-field">
							...
							<input type="password" name="senha" id="autocomplete16" class="white-text" required="">
							<label for="autocomplete16" class="white-text">Senha</label>
						</div>
					</div>
				</div>
			</div>
